...
function widgets.setup()
    awful.screen.connect_for_each_screen(function(s)
        ...
        -- Define the wiboxes
        s.widgets.tags.wibox = wibox { border_width = 1, border_color = beautiful.taglist.border, height = 25, width = 186, visible = true, bg = '#a8a8a826', fg=beautiful.taglist.fg.normal, type = 'dock', }
        s.widgets.prompt.wibox = wibox { border_width = 1, border_color = beautiful.prompt.border, height = 25, width = 512, visible = false, ontop = true, bg = beautiful.prompt.bg, fg = beautiful.prompt.fg, type = 'dock', shape = gears.shape.hexagon}
        s.widgets.tasklist.wibox = wibox {border_width = 1, border_color = beautiful.mpd.ctl.border, height = 25, width = 1280, visible = true, bg = '#00', type = 'dock'}
        s.widgets.mpd.ctl.wibox = wibox { border_width = 1, border_color = beautiful.mpd.ctl.border, height = 25, width = 116, visible = true, bg = beautiful.mpd.ctl.bg, fg = beautiful.mpd.ctl.fg, type = 'dock', }
        s.widgets.mpd.now_playing.wibox = wibox { border_width = 1, border_color = beautiful.mpd.now_playing.border, height = 25, width = 640, visible = false, bg = beautiful.mpd.now_playing.bg, fg = beautiful.mpd.now_playing.fg,  type = 'dock', shape = gears.shape.hexagon}
