...
editor     = os.getenv("EDITOR") or "nano" or "nvim"
...
gui_editor = "gedit"
graphics   = "gimp"
musicplr   = terminal .. " -e ncmpcpp -c MDP"
...
tags = {
   ...
   layout = { --[[1]]layouts[1], --[[2]]layouts[2], --[[3]]layouts[2], --[[4]]layouts[2], --[[5]]layouts[2], --[[6]]layouts[3], --[[7]]layouts[2], --[[8]]layouts[2], --[[9}]]layouts[1] }
}
for s = 1, screen.count() do
...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        gears.wallpaper.maximized("/home/tony/Pictures/pictures/Desktop Wallpapers/Cowboy Bebop/1389170184071.jpg" , s, true)
    end
end
-- }}}
...
mylauncher = awful.widget.launcher({ image = "/home/tony/.icons/arch buttons/start-here lp blue.png",
                                     menu = mymainmenu })
-- }}}
...
mailwidget = lain.widgets.imap({
    ...
    mail     = "professoroptics@gmail.com",
...
function ()
    awful.util.spawn_with_shell("mpc prev || ncmpc prev || pms prev || ncmpcpp prev")
    mpdwidget.update()
end)))
next_icon:buttons(awful.util.table.join(awful.button({}, 1,
function ()
    awful.util.spawn_with_shell("mpc next || ncmpc next || pms next || ncmcpp next")
    mpdwidget.update()
end)))
stop_icon:buttons(awful.util.table.join(awful.button({}, 1,
function ()
    play_pause_icon:set_image(beautiful.play)
    awful.util.spawn_with_shell("mpc stop || ncmpc stop || pms stop || ncmpcpp stop")
    mpdwidget.update()
end)))
play_pause_icon:buttons(awful.util.table.join(awful.button({}, 1,
function ()
    awful.util.spawn_with_shell("mpc toggle || ncmpc toggle || pms toggle || ncmpcpp toggle")
    mpdwidget.update()
end)))
...
--awful.util.spawn_with_shell("qeary")
--awful.util.spawn_with_shell("qute")
...
awful.rules.rules = {
    ...
    { rule = { class = "Terminator", instance = "MDP" }, properties = { tag = tags [1][5]}}, 

    { rule = {instance = "libreoffice"}, properties = { tag = tags [1][7]}},
    ...
    { rule = {class = "xine"}, properties = { tag = tags [1][6]}},

    { rule = {class = "Terminator", instance="alpine"}, properties = { tag = tags [1][4]}},
    
    { rule = {class = "Terminator", instance="weechat" or "Weechat"}, properties = { tag = tags [1][8]}},

    { rule = {class = "qTox"}, properties = { tag = tags [1][8]}},

    { rule = {class = "Terminator", instance="startup"}, properties = { tag = tags [1][2]}},
}
...
-- Widgets that are aligned to the right local right_layout = wibox.layout.fixed.horizontal() right_layout:add(awful.titlebar.widget.floatingbutton(c)) right_layout:add(awful.titlebar.widget.maximizedbutton(c)) right_layout:add(awful.titlebar.widget.stickybutton(c))
